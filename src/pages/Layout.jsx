            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ml-auto justify-content-end"> {}
                    <li className="nav-item">
                        <Link className="nav-link text-white" to="about">Employee</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link text-white" to="EmployeeList">Contact</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link text-white" to="Employee">Services</Link>
                    </li>
                </ul>
            </div>
        </div>
